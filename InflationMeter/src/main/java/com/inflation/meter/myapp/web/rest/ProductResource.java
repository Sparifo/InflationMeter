...
/**
 * REST controller for managing {@link com.inflation.meter.myapp.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getMounth() != null) {
                    existingProduct.setMounth(product.getMounth());
                }
    ...
    public ResponseEntity<List<String>> getNameProducts() {
        log.debug("REST request to get Product Names");
        List<String> page = productRepository.findAllNameProducts();


//        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(new HttpHeaders()).body(page);
    }
}
