...
import com.inflation.meter.myapp.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    private static final String DEFAULT_MOUNTH = "AAAAAAAAAA";
    private static final String UPDATED_MOUNTH = "BBBBBBBBBB";
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getMounth()).isEqualTo(DEFAULT_MOUNTH);
        ...
        assertThat(testProduct.getAttribute()).isEqualTo(DEFAULT_ATTRIBUTE);
    }
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].mounth").value(hasItem(DEFAULT_MOUNTH)))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.mounth").value(DEFAULT_MOUNTH))
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getMounth()).isEqualTo(UPDATED_MOUNTH);
        ...
        assertThat(testProduct.getAttribute()).isEqualTo(UPDATED_ATTRIBUTE);
    }
